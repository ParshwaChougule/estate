...
function BuyProperties({ statusFilter = 'all', searchFilters = {} }) {
...
${property.type !== 'plots' ? `${property.bedrooms} Bedrooms | ${property.bathrooms} Bathrooms` : ''}
AREA: ${property.area} Sq Ft
STATUS: ${getStatusText(property.status || 'available')}

${property.description ? `HIGHLIGHTS: ${property.description}` : ''}

Don't miss this incredible opportunity!
Premium location with excellent connectivity
Perfect for investment or personal use

Contact us NOW for site visit & best deals!
  ...
  useEffect(() => {
    ...
    const unsubscribe = onValue(propertiesRef, (snapshot) => {
      if (snapshot.exists()) {
        ...
        const buyProperties = Object.keys(propertiesData)
          .map(key => ({
            id: key,
            ...propertiesData[key]
          }))
          .filter(property => property.listingType === 'buy');
  ...
  return (
    <Container className="my-5">
      <Row className="mb-4 align-items-center">
        <Col>
          <h2 className="fw-bold section-title">Properties for Sale</h2>
        </Col>
        <Col className="text-end">
          {filteredProperties.length > 3 && (
            ...
            >
              {showAll ? 'Show Less' : `View More (${filteredProperties.length - 3} more)`}
            </Button>
          )}
        </Col>
      </Row>
                  ...
                  <Card.Body className="d-flex flex-column">
                    ...
                    <div className="property-features mb-3">
                      <Row className="text-center">
                        ...
                        <Col xs={property.type === 'plots' ? 12 : 4}>
                    ...
                    <div className="mt-auto">
                      <div className="d-flex gap-2 mt-auto">
                        ...
                        <Button 
                          as="a" 
                          href={`https://wa.me/919011041008?text=I'm interested in buying ${property.title} located at ${property.location}`}
                          target="_blank"
            ...
            <Col className="text-center py-5">
              <p className="text-muted">
                {searchFilters.location || searchFilters.priceRange || searchFilters.bedrooms 
                  ? `No properties for sale found matching your search criteria.`
