...
import { FaBed, FaBath, FaRulerCombined, FaMapMarkerAlt, FaHeart, FaArrowLeft, FaShare } from "react-icons/fa";
  ...
  useEffect(() => {
    ...
    const unsubscribe = onValue(propertiesRef, (snapshot) => {
      if (snapshot.exists()) {
        ...
        const residentialProperties = Object.keys(propertiesData)
          .map(key => ({
            id: key,
            ...propertiesData[key]
          }))
    ...
    <Container className="my-5">
      <Row className="mb-4">
        <Col>
          ...
          <h1 className="fw-bold section-title">All Residential Properties</h1>
          <p className="text-muted">Browse through our complete collection of residential properties</p>
        </Col>
      </Row>
          ...
          {filteredProperties.length > 0 ? (
            ...
            <Col className="text-center py-5">
              <p className="text-muted">
                {showFavoritesOnly 
                  ? `No residential properties found in your favorites.`
