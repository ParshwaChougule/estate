...
function RentProperties({ statusFilter = 'all', searchFilters = {} }) {
...
💰 *Rent:* ₹${property.price}
${property.type !== 'plots' ? `🛏️ *Bedrooms:* ${property.bedrooms}` : ''}
${property.type !== 'plots' ? `🚿 *Bathrooms:* ${property.bathrooms}` : ''}
  ...
  useEffect(() => {
    ...
    const unsubscribe = onValue(propertiesRef, (snapshot) => {
      if (snapshot.exists()) {
        ...
        const rentProperties = Object.keys(propertiesData)
          .map(key => ({
            id: key,
            ...propertiesData[key]
          }))
  ...
  return (
    <Container className="my-5">
      <Row className="mb-4 align-items-center">
        <Col>
          <h2 className="fw-bold section-title">Properties for Rent</h2>
        </Col>
                  ...
                  <Card.Body className="d-flex flex-column">
                    ...
                    <div className="mt-auto">
                      <div className="d-flex gap-2 mt-auto">
                        ...
                        <Button 
                          as="a" 
                          href={`https://wa.me/919011041008?text=I'm interested in renting ${property.title} located at ${property.location}`}
                          target="_blank"
            ...
            <Col className="text-center py-5">
              <p className="text-muted">
                {searchFilters.location || searchFilters.priceRange || searchFilters.bedrooms 
                  ? `No properties for rent found matching your search criteria.`
                  : `No properties for rent available at the moment.`
                }
              </p>
            </Col>
          )}
